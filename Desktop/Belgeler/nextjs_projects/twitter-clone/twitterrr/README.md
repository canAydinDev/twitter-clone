    ...
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
      <div>
        ...
        <p className="mt-8 max-w-xl text-lg leading-8 text-muted-foreground">
          Our innovative platform provides a seamless shopping experience,
          allowing customers to easily find and purchase the products they love.
          With a focus on quality and convenience, we aim to revolutionize the
          retail industry and bring joy to every shopper.
        </p>
  ...
  return (
    <section>
      ...
      <p className="mt-6 text-lg tracking-wide leading-8 max-w-2xl mx-auto text-muted-foreground">
        Our commitment to providing a unique and enjoyable shopping experience
        drives everything we do. From carefully curated product selections to
        exceptional customer service, we strive to create a store that our
...
### .env.local 'deki leri vercel e ekle ve github a tekrar gonder
